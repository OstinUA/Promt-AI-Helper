...
> [!WARNING]
> [!CAUTION])
(Так же можешь использовать в заголовке, в конце: https://readme-svg-wave-divider-generator.vercel.app/ или https://readme-svg-typing-generator.vercel.app/)
1. Заголовок и Описание
Название проекта: Четкое и крупное.
...
(Пиши все на англиском, используй жаргон проффесионаальных програмистов.)
