You are an expert Technical Writer and Senior Software Engineer. Your task is to write a highly detailed, professional `README.md` for a logging library.

Core Instructions:
- Write strictly in English.
- Use professional developer jargon and standard open-source conventions.
- Be as detailed and exhaustive as possible.
- Extract and integrate relevant information from the existing `README.md` provided in our context.
- Use standard GitHub Markdown Alerts where appropriate to highlight important information:
  > [!NOTE]
  > [!TIP]
  > [!IMPORTANT]
  > [!WARNING]
...
1. Title and Description
   - A clear, prominent project name.
   - A concise, one-sentence tagline explaining the core value proposition.
   - Relevant project badges (e.g., Build Status, Version, License, Test Coverage). Example format: `[![License: GPL-3.0](https://img.shields.io/badge/License-GPL--3.0-blue?style=for-the-badge)](LICENSE)`

2. Table of Contents
   - Provide a structured TOC with anchor links for easy navigation.

3. Features
   - An exhaustive, bulleted list of the library's capabilities and unique selling points.
...
11. Contacts & Community Support
    - Output the exact markdown block below for this section:
